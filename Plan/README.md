...
当前约定：Unity 2022.3、3D、立方体占位、独立进程服务器、kcp2k + protobuf。第 1 周经典帧同步 demo，第 2 周预测回滚 + 可选 C++ 换服务器。
...
- 网络底层是纯 C# Transport 外观。传输用 kcp2k，不整包引入 Mirror / Fantasy Session。朋友说的三种是 KCP/TCP/WebSocket，本项目只用 KCP。
